...
import Bootstrap from "../components/icons/Flask";
import knime from "../components/icons/knime";
import ReactJs from "../components/icons/ReactJs";
import NextJs from "../components/icons/NextJs";
import NodeJs from "../components/icons/NodeJs";
import python from "../components/icons/python";
import Figma from "../components/icons/AndroidStudio";
import Photoshop from "../components/icons/sql";
import Illustrator from "../components/icons/jupyter";
import AfterEffects from "../components/icons/Postman";
			...
			<div
				...
				<div className='container relative z-30 mx-auto'>
						...
						<div className='container relative flex flex-col items-start justify-center flex-grow px-0 mx-auto md:px-20 lg:px-24 section'>
							<div className='w-full'>
								...
								<p className='w-4/5 text-xl md:w-full'>
									I design and build websites & projects that looks good, and
									work well.
								</p>
								<button
						...
						<div className='flex flex-col'>
							...
							<div className='flex flex-col-reverse items-start w-full md:flex-row'>
								<div className='flex flex-col w-full md:pr-8 md:w-3/5'>
									<p className='text-lg'>
										Hello! I&apos;m Rizwan, and I&apos;m a developer. I&apos;ve
										been involved in competitive programming, and I used to
										develop websites and train ML models.
									</p>
									{/* <p className="text-lg">
                    ...
                    never looked back.
									...
									<p className='text-lg'>
										I am an ambitious and creative person with an organized
										personality. Looking forward to expand my knowledge and to
										gain experience to build a great career I am a student with
										interest and experience in various fields such as Web
										Development, Competitive Programming & Machine Learning and
										other stuffs
									</p>
									<p className='text-lg'>
										In recent years, I&apos;ve been focused on programming,
										building and creating exciting projects that solve
										real-world problems.
									</p>
                ...
                return <ProjectCard project={project} key={i} />;
					...
					<section
						...
						<div className='w-full mr-auto grid gap-4 grid-cols-4 sm:grid-cols-4 md:grid-cols-8 mt-4'>
							{/* C langiage */}
							<Icon
								IconType={C} // Assuming you have an icon for C Language
								title='C Language'
								width={"w-16"}
								height={"h-16"}
								padding={"p-0"}
					...
					<section
						...
						>
							...
							{/* <FeaturedProjectCard
								...
								imgWidth={"1366"}
								imgHeight={"666"}
								imgSrc={"/projects/report ease.jpg"}
								liveLink={null}
						...
						<div className='grid grid-flow-row grid-rows-1 gap-4 grid-col-1 lg:grid-cols-3'>
							{projects.map(function (project, i) {
								return <ProjectCard project={project} key={i} />;
							})}
						</div>
					...
					<section
						...
						ref={blogRef}>
						{/* Blog header  */}
						<h2 className='text-5xl'>Certificates</h2>
						<hr className='bg-brand w-40 h-1.5 mt-4 mb-6 border-0'></hr>
						...
						<div
							...
							<a href='https://drive.google.com/drive/folders/11SymyHhhB1OFCO7O5NzyelO-LnJI2G7x'>
								<h3 className='btn-xs btn-brand self-start mt-3'>
									Scan or Click Here 👆
								</h3>
							</a>
						</div>
					...
					<section
						...
						<div className='flex flex-col-reverse w-full md:flex-row'>
							<div className='w-full mb-4 md:pl-0 md:mb-0'>
								<p className='text-lg'>
									I&apos;m currently available to get n new projects, so get in
