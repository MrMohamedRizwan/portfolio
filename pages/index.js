            ...
            <div className="container relative flex flex-col items-start justify-center flex-grow px-0 mx-auto md:px-20 lg:px-24 section">
              <div className="w-full">
                ...
                <p className="w-4/5 text-xl md:w-full">
                  I design and build websites & projects that looks good, and work well.
                </p>
                <button
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-col-reverse items-start w-full md:flex-row">
                <div className="flex flex-col w-full md:pr-8 md:w-3/5">
                  ...
                  <p className="text-lg">
                  I am an ambitious and creative person with an organized personality. Looking forward to expand my knowledge and to gain experience to build a great career I am a student with interest and experience in various fields such as Web Development, Competitive Programming & Machine Learning and other stuffs
                  </p>
                  <p className="text-lg">
                    In recent years, I&apos;ve been focused on programming,
                    building and creating exciting
...
<Icon
            ...
            <div 
            className="grid grid-flow-row grid-rows-1 gap-4 grid-col-1 lg:grid-cols-3"
          ...
          alt={`user interface`}
            ...
            <div style={{ display: "flex",justifyContent: 'center',alignItems: 'center' }}>
              <a href="https://drive.google.com/drive/folders/11SymyHhhB1OFCO7O5NzyelO-LnJI2G7x"><h3 className="btn-xs btn-brand self-start mt-3">Scan or Click Here 👆</h3></a>
            </div>
          ...
          >
            ...
            <div className="flex flex-col-reverse w-full md:flex-row">
              <div className="w-full mb-4 md:pl-0 md:mb-0">
                <p className="text-lg">
                  I&apos;m currently available to get n new projects,
